...
function main() {
  const inputs = [
    [[new Interval(1, 2), new Interval(5, 6)], [new Interval(1, 3)], [new Interval(4, 10)]],
    [
    ...
    [
      [new Interval(1, 2), new Interval(3, 4), new Interval(5, 6), new Interval(7, 8)],
  ...
  inputs.forEach((schedule) => {
    ...
    console.log("\tEmployees' free time:", display(employeeFreeTime(schedule)));
